...
namespace UserModule_SERIALSAMPLER2_2
{
    public class UserModuleClass_SERIALSAMPLER2_2 : SplusObject
    {
        ...
        object TRIGGER_OnPush_0 ( Object __EventInfo__ )
            ...
            try
            {
                ...
                ushort __FN_FOREND_VAL__1 = (ushort)400; 
    ...
    public override void LogosSplusInitialize()
    {
        ...
        CONVERT = new InOutArray<DigitalInput>( 400, this );
        ...
        SERIALI = new InOutArray<StringInput>( 400, this );
        for( uint i = 0; i < 400; i++ )
        {
            SERIALI[i+1] = new Crestron.Logos.SplusObjects.StringInput( SERIALI__AnalogSerialInput__ + i, SERIALI__AnalogSerialInput__, 400, this );
            m_StringInputList.Add( SERIALI__AnalogSerialInput__ + i, SERIALI[i+1] );
        }
        
        SERIALO = new InOutArray<StringOutput>( 400, this );
        for( uint i = 0; i < 400; i++ )
        {
    ...
    public UserModuleClass_SERIALSAMPLER2_2 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
