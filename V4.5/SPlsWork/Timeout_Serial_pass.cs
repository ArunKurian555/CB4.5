...
namespace UserModule_TIMEOUT_SERIAL_PASS
{
    public class UserModuleClass_TIMEOUT_SERIAL_PASS : SplusObject
    {
    ...
    public UserModuleClass_TIMEOUT_SERIAL_PASS ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
